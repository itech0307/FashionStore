<?php
#nếu người dùng đã đăng nhập thì thực thi isset($_SESSION["uid"])
# true thì sẽ đưa người dùng đến profile.php
if (isset($_SESSION["uid"])) {
	header("location:profile.php");
}
//tại action.php page nếu người dùng bấm "ready to checkout" thì lúc đó sẽ chuyển dữ liệu dưới dạng biểu mẫu từ trang action.php
if (isset($_POST["login_user_with_product"])) {
	//mảng danh sách sản phẩm
	$product_list = $_POST["product_id"];
	//chuyển mảng thành định dạng json vì mảng không thể lưu trữ trong cookie
	$json_e = json_encode($product_list);
	//tạo cookie và tên của cookie là product_list
