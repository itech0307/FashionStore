				...
				<div class='col-md-4'>
							<div class='panel panel-info'>
								...
								<div class='panel-body'>
									<img src='img/$pro_image' style='width:220px; height:250px;'/>
								</div>
			...
			while ($row = mysqli_fetch_array($query)) {
				...
				echo '
					<div class="row">
						...
						<div class="col-md-3"><img class="img-responsive" src="img/' . $product_image . '" /></div>
		...
		if (mysqli_num_rows($query) > 0) {
			...
			while ($row = mysqli_fetch_array($query)) {
				...
				'<div class="row">
								...
								<div class="col-md-2"><img class="img-responsive" src="img/' . $product_image . '"></div>
